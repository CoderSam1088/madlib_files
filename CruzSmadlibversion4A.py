...
def newWindow():
    ...
    my_label = ttk.Label(window, text="From my _"+building+ "_ window, I see an oversized _"+adj_1+"_ billboard"
      "\nwith his face on it: _"+name+"_, the Great _"+occupation+"_.")
    my_label.grid(row=1, column=1)
    my_label2 = ttk.Label(window, text="I absent-mindedly _"+verb_1+"_ the pages of the phone book and"
          "\ncome across a _"+noun_1+"_ map. Sipping my _"+drink+"_,"
          "\nI run my fingers along the streets from the _"+name_of_place+"_ to the opera hall. Not more than a _"+str(number_1)+"_ walk.")
    my_label2.grid(row=2, column=1)
    my_label3 = ttk.Label(window, text="I glance at the _"+obj_1+"_. The show starts in _"+str(number_2)+"_ hour. "
          "\nPlenty of time! I gulp the last _"+str(number_3)+"_ sips of my _"+drink+"_ and hop in the shower."
          "\nSoon I’m on my way to the _"+name_of_place_1+"_, carrying a _"+adj_2+"_ _"+obj_2+"_ handbag and a _"+adj_3+"_ smile.")
    my_label3.grid(row=3, column=1)
    my_label4 = ttk.Label(window, text="The billboard looks even more impressive from outside. The Great _"+name+"_'s eyes seem to be"
          "\nglancing through me. I _"+verb_2+"_ and _"+verb_3+"_ faster. I feel like a _"+type_of_person+"_ about to open her _"+open_obj+"_.")
    my_label4.grid(row=4, column=1)
    my_label5 = ttk.Label(window, text="The hall is _"+adj_4+"_ when I come in; the show is about to begin. "
          "\nI make my way to _"+place+"_ just as the great _"+occupation+"_ puts on his top hat.")
    my_label5.grid(row=5, column=1)

    my_label6 = ttk.Label(window, text='"Daddy, Im so _'+emotion+'_ to see you," I say in a half-whisper. '
          '\n"Im in town for the _'+event+'_, '
          '\nbut I just couldnt miss your show.'
          "\nI give him a quick hug and go back into the seating area,"
          "\nleaving him with a _"+adj_6+"_ smile. I settle down in"
          "\nthe darkness, and the curtains open.")
    my_label6.grid(row=6, column=1)

    my_label7 = ttk.Label(window, text="Magically, that _"+noun_2+"_ remains the Great _"+name+"_'s best performance to this day.")
